...
def startTmate():
    pass
def screenKillSession(sessionName):
    cmdList = [
        'screen -ls',
    ]
    ...
    for key in sessionDict:
        if sessionName in sessionDict[key]:
            cmdList = [
...
if __name__ == '__main__':
    ...
    currTime = yesterday.strftime('%Y-%m-%d-%H-%M-%S')
    sessionName = 'screenshot-{}'.format(currTime)
    screenKillSession(sessionName)
    picDir = '/home/limin/Documents/jianguoyun/Nutstore/screenshot/'
