...
if __name__ == '__main__':
    ...
    localDir = 'logs_today-{}'.format(currTime)
    cmdList = [
        'screen -dmS testApk-{}'.format(currTime),
        'screen -S testApk-{} -X stuff '\
        '"python /home/limin/Desktop/mygit/tools/getLog.py '\
        '-d {} -t 40 -l '
        '~/Desktop/logs_today/{}/\n"'.format(currTime,apkDir,localDir),
    ]
    #python getLog.py -d ~/Desktop/apks/huawei/todayApk-2019-08-13 -t 40 -l ~/Desktop/logs_today/logs_today0813
    print(cmdList)
